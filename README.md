...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-17--20%3A53%3A00-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2099-orange.svg)
...
> 运行分析：从 `19` 个活跃源中抓取 `2755` 个节点，耗时 `3.25s`。去重后保留 `2099` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 58 | 12 | 53 | 291 | 53 | 33 | 26 | 29 | 22 | 8 | 33 | 4 | 11 | 7 | 96 | 21 | 6 | 8 | 7 | 1321 | **2099** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-17 20:53:01`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1499** 个 | `54.99%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.07%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.83%` |
| 4 | `[长效备份] hysteria2 节点` | **150** 个 | `5.50%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **71** 个 | `2.60%` |
| 6 | `📡 shaoyouvip 每日更新` | **66** 个 | `2.42%` |
| 7 | `[长效备份] hy2 节点` | **56** 个 | `2.05%` |
...
| 17 | `📱 Pawdroid 免费节点库` | **13** 个 | `0.48%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.37%` |
| **-** | **总计 (包含跨源重合)** | **2726** 个 | `100.00%` |
