...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-20--23%3A38%3A08-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2085-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-20 23:38:08`
> 运行分析：从 `19` 个活跃源中抓取 `2694` 个节点，耗时 `2.30s`。去重后保留 `2085` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 12 | 51 | 263 | 37 | 28 | 21 | 22 | 15 | 13 | 4 | 21 | 4 | 13 | 7 | 6 | 122 | 7 | 6 | 6 | 4 | 1373 | **2085** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1589** 个 | `59.40%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `20.56%` |
| 3 | `📡 Zhangkai 系列` | **144** 个 | `5.38%` |
| 4 | `[长效备份] hysteria2 节点` | **100** 个 | `3.74%` |
| 5 | `[长效备份] hy2 节点` | **48** 个 | `1.79%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `1.64%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.61%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.75%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.52%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.52%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.52%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.52%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.52%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.52%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.52%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.52%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.37%` |
| 18 | `📡 shaoyouvip 每日更新` | **8** 个 | `0.30%` |
| 19 | `我的私密机场 1` | **7** 个 | `0.26%` |
| **-** | **总计 (包含跨源重合)** | **2675** 个 | `100.00%` |
