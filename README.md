...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-17--11%3A53%3A43-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2108-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-17 11:53:43`
> 运行分析：从 `19` 个活跃源中抓取 `2703` 个节点，耗时 `3.22s`。去重后保留 `2108` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 57 | 12 | 48 | 306 | 41 | 30 | 26 | 31 | 25 | 9 | 36 | 4 | 11 | 7 | 117 | 10 | 7 | 12 | 7 | 1312 | **2108** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-17 11:53:44`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1499** 个 | `56.06%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.46%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.95%` |
| 4 | `[长效备份] hysteria2 节点` | **113** 个 | `4.23%` |
| 5 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.74%` |
| 6 | `[长效备份] hy2 节点` | **54** 个 | `2.02%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.61%` |
| 8 | `📱 Pawdroid 免费节点库` | **19** 个 | `0.71%` |
