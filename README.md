...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-12--05%3A54%3A12-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1993-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-12 05:54:12`
> 运行分析：从 `19` 个活跃源中抓取 `2592` 个节点，耗时 `3.68s`。去重后保留 `1993` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 11 | 47 | 312 | 36 | 26 | 21 | 31 | 23 | 6 | 4 | 25 | 4 | 8 | 8 | 136 | 6 | 5 | 4 | 5 | 1228 | **1993** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-12 05:54:14`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1405** 个 | `54.82%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.34%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.20%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.90%` |
| 5 | `[长效备份] hy2 节点` | **71** 个 | `2.77%` |
| 6 | `[长效备份] hysteria2 节点` | **49** 个 | `1.91%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `1.83%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.68%` |
| 9 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.78%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.55%` |
| 11 | `📡 FreeFQ 每日福利` | **14** 个 | `0.55%` |
| 12 | `[动态日期] NodeFree TXT` | **14** 个 | `0.55%` |
| 13 | `[动态日期] NodeFree YAML` | **14** 个 | `0.55%` |
| 14 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.55%` |
| 15 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.55%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `0.55%` |
| 17 | `[动态日期] oneClash YAML` | **14** 个 | `0.55%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2563** 个 | `100.00%` |
