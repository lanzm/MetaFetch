...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--03%3A42%3A00-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1621-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 03:42:00`
> 运行分析：从 `19` 个活跃源中抓取 `2088` 个节点，耗时 `3.24s`。去重后保留 `1621` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 11 | 46 | 239 | 35 | 24 | 23 | 17 | 14 | 12 | 4 | 5 | 13 | 8 | 60 | 4 | 1059 | **1621** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 03:42:01`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `51.27%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.63%` |
| 3 | `[长效备份] hysteria2 节点` | **84** 个 | `4.09%` |
| 4 | `📡 Zhangkai 系列` | **74** 个 | `3.60%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `2.14%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.09%` |
| 7 | `[动态日期] NodeFree TXT` | **25** 个 | `1.22%` |
| 8 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.22%` |
| 9 | `[动态日期] oneClash TXT` | **25** 个 | `1.22%` |
| 10 | `[动态日期] NodeFree YAML` | **24** 个 | `1.17%` |
| 11 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.17%` |
| 12 | `[动态日期] oneClash YAML` | **24** 个 | `1.17%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.68%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.68%` |
| 15 | `📡 shaoyouvip 每日更新` | **14** 个 | `0.68%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.49%` |
| 17 | `📱 Pawdroid 免费节点库` | **8** 个 | `0.39%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2054** 个 | `100.00%` |
