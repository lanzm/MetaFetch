...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-25--16%3A12%3A51-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1507-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-25 16:12:51`
> 运行分析：从 `19` 个活跃源中抓取 `1964` 个节点，耗时 `2.67s`。去重后保留 `1507` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇮🇩印尼 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 13 | 46 | 232 | 37 | 24 | 18 | 18 | 18 | 7 | 6 | 13 | 5 | 7 | 37 | 5 | 974 | **1507** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-25 16:12:52`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **971** 个 | `50.31%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `28.34%` |
| 3 | `📡 Zhangkai 系列` | **61** 个 | `3.16%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **53** 个 | `2.75%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `2.23%` |
| 6 | `[长效备份] hysteria2 节点` | **41** 个 | `2.12%` |
| 7 | `[动态日期] NodeFree TXT` | **25** 个 | `1.30%` |
| 8 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.30%` |
| 9 | `[动态日期] oneClash TXT` | **25** 个 | `1.30%` |
| 10 | `[动态日期] NodeFree YAML` | **24** 个 | `1.24%` |
| 11 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.24%` |
| 12 | `[动态日期] oneClash YAML` | **24** 个 | `1.24%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.73%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.73%` |
| 15 | `📱 Pawdroid 免费节点库` | **12** 个 | `0.62%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.52%` |
| 17 | `📡 shaoyouvip 每日更新` | **9** 个 | `0.47%` |
| 18 | `[长效备份] hy2 节点` | **8** 个 | `0.41%` |
| **-** | **总计 (包含跨源重合)** | **1930** 个 | `100.00%` |
