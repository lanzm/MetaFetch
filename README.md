...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-08--19%3A43%3A10-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-933-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-08 19:43:10`
> 运行分析：从 `10` 个活跃源中抓取 `1075` 个节点，耗时 `2.38s`。去重后保留 `933` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 47 | 251 | 35 | 27 | 25 | 16 | 14 | 5 | 5 | 17 | 3 | 5 | 10 | 6 | 1 | 2 | 4 | 1 | 10 | 13 | 120 | 12 | 3 | 3 | 2 | 3 | 7 | 3 | 2 | 3 | 1 | 1 | 224 | **933** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `51.94%` |
| 2 | `[长效备份] hysteria2 节点` | **147** 个 | `13.88%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.60%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **68** 个 | `6.42%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.06%` |
| 6 | `[长效备份] hy2 节点` | **36** 个 | `3.40%` |
| 7 | `📡 shaoyouvip 每日更新` | **30** 个 | `2.83%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.89%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.32%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.66%` |
| **-** | **总计 (包含跨源重合)** | **1059** 个 | `100.00%` |
