...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-18--20%3A54%3A19-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2075-orange.svg)
...
> 运行分析：从 `19` 个活跃源中抓取 `2707` 个节点，耗时 `3.71s`。去重后保留 `2075` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 54 | 14 | 46 | 306 | 35 | 27 | 23 | 31 | 19 | 5 | 4 | 27 | 4 | 12 | 7 | 10 | 93 | 13 | 6 | 8 | 7 | 1324 | **2075** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-18 20:54:20`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1514** 个 | `56.51%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.42%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.94%` |
| 4 | `[长效备份] hysteria2 节点` | **126** 个 | `4.70%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `2.09%` |
| 6 | `[长效备份] hy2 节点` | **50** 个 | `1.87%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.61%` |
| 8 | `📡 shaoyouvip 每日更新` | **42** 个 | `1.57%` |
