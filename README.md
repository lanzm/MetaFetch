...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-09--19%3A48%3A53-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-930-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-09 19:48:53`
> 运行分析：从 `10` 个活跃源中抓取 `1080` 个节点，耗时 `2.26s`。去重后保留 `930` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 46 | 249 | 35 | 27 | 26 | 18 | 16 | 5 | 5 | 16 | 1 | 4 | 10 | 7 | 1 | 1 | 2 | 4 | 1 | 8 | 14 | 121 | 17 | 5 | 5 | 2 | 4 | 3 | 2 | 2 | 1 | 1 | 1 | 219 | **930** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `51.69%` |
| 2 | `[长效备份] hysteria2 节点` | **153** 个 | `14.38%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.53%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **68** 个 | `6.39%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.04%` |
| 6 | `[长效备份] hy2 节点` | **37** 个 | `3.48%` |
| 7 | `📡 shaoyouvip 每日更新` | **28** 个 | `2.63%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.88%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.32%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.66%` |
| **-** | **总计 (包含跨源重合)** | **1064** 个 | `100.00%` |
