...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-25--18%3A37%3A26-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1567-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-25 18:37:26`
> 运行分析：从 `19` 个活跃源中抓取 `2022` 个节点，耗时 `2.37s`。去重后保留 `1567` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇮🇪爱尔兰 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 46 | 14 | 46 | 232 | 34 | 25 | 18 | 18 | 16 | 12 | 21 | 13 | 7 | 78 | 4 | 4 | 979 | **1567** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-25 18:37:27`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **971** 个 | `48.84%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `27.52%` |
| 3 | `📡 Zhangkai 系列` | **119** 个 | `5.99%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **53** 个 | `2.67%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `2.16%` |
| 6 | `[长效备份] hysteria2 节点` | **40** 个 | `2.01%` |
| 7 | `[动态日期] NodeFree TXT` | **25** 个 | `1.26%` |
| 8 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.26%` |
| 9 | `[动态日期] oneClash TXT` | **25** 个 | `1.26%` |
| 10 | `[动态日期] NodeFree YAML` | **24** 个 | `1.21%` |
| 11 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.21%` |
| 12 | `[动态日期] oneClash YAML` | **24** 个 | `1.21%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.70%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.70%` |
| 15 | `📱 Pawdroid 免费节点库` | **12** 个 | `0.60%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.50%` |
| 17 | `📡 shaoyouvip 每日更新` | **10** 个 | `0.50%` |
| 18 | `[长效备份] hy2 节点` | **8** 个 | `0.40%` |
| **-** | **总计 (包含跨源重合)** | **1988** 个 | `100.00%` |
