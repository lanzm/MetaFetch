...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-13--06%3A31%3A26-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-13 06:31:26`
> 运行分析：从 `10` 个活跃源中抓取 `1160` 个节点，耗时 `1.90s`。去重后保留 `963` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 12 | 49 | 258 | 34 | 25 | 29 | 21 | 19 | 5 | 3 | 21 | 2 | 4 | 9 | 10 | 1 | 2 | 2 | 1 | 1 | 11 | 13 | 122 | 9 | 2 | 6 | 7 | 1 | 6 | 3 | 1 | 3 | 1 | 3 | 1 | 1 | 1 | 223 | **963** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `48.08%` |
| 2 | `[长效备份] hysteria2 节点` | **179** 个 | `15.65%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.59%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `8.83%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **59** 个 | `5.16%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.76%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.15%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.22%` |
| 9 | `📱 Pawdroid 免费节点库` | **11** 个 | `0.96%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.61%` |
| **-** | **总计 (包含跨源重合)** | **1144** 个 | `100.00%` |
