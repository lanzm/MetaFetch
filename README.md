...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-09--13%3A13%3A53-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-09 13:13:53`
> 运行分析：从 `10` 个活跃源中抓取 `1106` 个节点，耗时 `2.04s`。去重后保留 `959` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 47 | 259 | 35 | 26 | 29 | 21 | 16 | 5 | 4 | 14 | 4 | 4 | 10 | 7 | 1 | 3 | 4 | 1 | 2 | 9 | 13 | 123 | 9 | 3 | 4 | 4 | 2 | 7 | 3 | 2 | 3 | 3 | 1 | 1 | 1 | 228 | **959** |
...
| 2 | `[长效备份] hysteria2 节点` | **146** 个 | `13.39%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.21%` |
| 4 | `📡 shaoyouvip 每日更新` | **66** 个 | `6.06%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `5.87%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.94%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.30%` |
