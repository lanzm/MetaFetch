...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-19--13%3A04%3A40-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-893-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-19 13:04:40`
> 运行分析：从 `10` 个活跃源中抓取 `1034` 个节点，耗时 `2.59s`。去重后保留 `893` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 46 | 242 | 34 | 26 | 19 | 15 | 16 | 4 | 3 | 16 | 3 | 3 | 7 | 3 | 1 | 3 | 1 | 1 | 3 | 8 | 15 | 120 | 16 | 2 | 6 | 3 | 1 | 6 | 3 | 1 | 3 | 1 | 1 | 2 | 1 | 207 | **893** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `53.87%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.10%` |
| 3 | `[长效备份] hysteria2 节点` | **94** 个 | `9.21%` |
| 4 | `📡 shaoyouvip 每日更新` | **80** 个 | `7.84%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.48%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.21%` |
| 7 | `[长效备份] hy2 节点` | **18** 个 | `1.76%` |
| 8 | `📱 Pawdroid 免费节点库` | **15** 个 | `1.47%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.37%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.69%` |
| **-** | **总计 (包含跨源重合)** | **1021** 个 | `100.00%` |
