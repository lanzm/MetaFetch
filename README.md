...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--19%3A22%3A47-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1614-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 19:22:47`
> 运行分析：从 `19` 个活跃源中抓取 `2082` 个节点，耗时 `3.72s`。去重后保留 `1614` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 51 | 12 | 44 | 254 | 33 | 24 | 23 | 18 | 16 | 16 | 4 | 4 | 13 | 7 | 4 | 70 | 1021 | **1614** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 19:22:49`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `51.42%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.71%` |
| 3 | `📡 Zhangkai 系列` | **81** 个 | `3.96%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **67** 个 | `3.27%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `2.10%` |
| 6 | `[长效备份] hysteria2 节点` | **40** 个 | `1.95%` |
...
| 13 | `📱 Pawdroid 免费节点库` | **17** 个 | `0.83%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.68%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.68%` |
| 16 | `📡 shaoyouvip 每日更新` | **13** 个 | `0.63%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.49%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2048** 个 | `100.00%` |
