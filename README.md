...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-19--09%3A34%3A46-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2161-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-19 09:34:46`
> 运行分析：从 `19` 个活跃源中抓取 `2814` 个节点，耗时 `5.32s`。去重后保留 `2161` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 53 | 13 | 53 | 309 | 37 | 29 | 31 | 36 | 17 | 15 | 28 | 4 | 12 | 7 | 5 | 117 | 8 | 9 | 11 | 9 | 1358 | **2161** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-19 09:34:47`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1566** 个 | `56.23%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `19.64%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.71%` |
| 4 | `[长效备份] hysteria2 节点` | **126** 个 | `4.52%` |
| 5 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.59%` |
