...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--13%3A52%3A04-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1681-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 13:52:04`
> 运行分析：从 `19` 个活跃源中抓取 `2156` 个节点，耗时 `3.35s`。去重后保留 `1681` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇺🇦乌克兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 61 | 13 | 49 | 261 | 34 | 33 | 29 | 20 | 16 | 14 | 8 | 14 | 7 | 4 | 81 | 8 | 4 | 4 | 5 | 1016 | **1681** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 13:52:05`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `49.62%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `25.78%` |
| 3 | `📡 shaoyouvip 每日更新` | **97** 个 | `4.57%` |
| 4 | `📡 Zhangkai 系列` | **81** 个 | `3.82%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `2.45%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.03%` |
| 7 | `[长效备份] hysteria2 节点` | **42** 个 | `1.98%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.18%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.18%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.18%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.13%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.13%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.13%` |
| 14 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.94%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.66%` |
| 16 | `📡 FreeFQ 每日福利` | **14** 个 | `0.66%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.47%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.09%` |
| **-** | **总计 (包含跨源重合)** | **2122** 个 | `100.00%` |
