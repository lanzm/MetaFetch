...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-20--15%3A35%3A19-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-859-orange.svg?style=flat-square)
...
> 运行分析：从 `10` 个活跃源中抓取 `1007` 个节点，耗时 `2.09s`。去重后保留 `859` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇹🇭泰国 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 43 | 13 | 45 | 239 | 32 | 25 | 17 | 13 | 17 | 4 | 3 | 14 | 2 | 3 | 7 | 3 | 1 | 1 | 1 | 1 | 1 | 9 | 14 | 119 | 6 | 2 | 4 | 2 | 4 | 3 | 1 | 2 | 2 | 1 | 1 | 204 | **859** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `55.33%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.49%` |
| 3 | `[长效备份] hysteria2 节点` | **94** 个 | `9.46%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **62** 个 | `6.24%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.33%` |
| 6 | `📡 shaoyouvip 每日更新` | **43** 个 | `4.33%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.01%` |
| 8 | `[长效备份] hy2 节点` | **17** 个 | `1.71%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.41%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.70%` |
| **-** | **总计 (包含跨源重合)** | **994** 个 | `100.00%` |
