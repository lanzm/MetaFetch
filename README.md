...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-02--03%3A16%3A14-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1791-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-02 03:16:14`
> 运行分析：从 `19` 个活跃源中抓取 `2369` 个节点，耗时 `3.13s`。去重后保留 `1791` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 45 | 13 | 45 | 291 | 33 | 26 | 23 | 19 | 13 | 21 | 4 | 11 | 10 | 8 | 112 | 5 | 4 | 1108 | **1791** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-02 03:16:15`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1256** 个 | `53.93%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.49%` |
| 3 | `📡 Zhangkai 系列` | **194** 个 | `8.33%` |
| 4 | `[长效备份] hysteria2 节点` | **58** 个 | `2.49%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `1.85%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **40** 个 | `1.72%` |
| 7 | `📡 shaoyouvip 每日更新` | **29** 个 | `1.25%` |
| 8 | `[动态日期] NodeFree YAML` | **20** 个 | `0.86%` |
| 9 | `[动态日期] v2rayShare YAML` | **20** 个 | `0.86%` |
| 10 | `[动态日期] oneClash YAML` | **20** 个 | `0.86%` |
| 11 | `[动态日期] NodeFree TXT` | **16** 个 | `0.69%` |
| 12 | `[动态日期] v2rayShare TXT` | **16** 个 | `0.69%` |
| 13 | `[动态日期] oneClash TXT` | **16** 个 | `0.69%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.60%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.60%` |
| 16 | `📱 Pawdroid 免费节点库` | **11** 个 | `0.47%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.43%` |
| 18 | `[长效备份] hy2 节点` | **5** 个 | `0.21%` |
| **-** | **总计 (包含跨源重合)** | **2329** 个 | `100.00%` |
