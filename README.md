...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-27--11%3A36%3A16-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1641-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-27 11:36:16`
> 运行分析：从 `19` 个活跃源中抓取 `2111` 个节点，耗时 `3.39s`。去重后保留 `1641` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇦🇹奥地利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 60 | 14 | 53 | 243 | 41 | 24 | 23 | 19 | 14 | 12 | 5 | 14 | 7 | 78 | 4 | 4 | 1026 | **1641** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-27 11:36:17`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1043** 个 | `50.22%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.34%` |
| 3 | `📡 Zhangkai 系列` | **86** 个 | `4.14%` |
| 4 | `[长效备份] hysteria2 节点` | **59** 个 | `2.84%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `2.50%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.07%` |
| 7 | `📡 shaoyouvip 每日更新` | **42** 个 | `2.02%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.20%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.20%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.20%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.16%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.16%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.16%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.67%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.67%` |
| 16 | `📱 Pawdroid 免费节点库` | **12** 个 | `0.58%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.48%` |
| 18 | `[长效备份] hy2 节点` | **8** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2077** 个 | `100.00%` |
