...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-01--21%3A38%3A04-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1784-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-01 21:38:04`
> 运行分析：从 `19` 个活跃源中抓取 `2349` 个节点，耗时 `3.63s`。去重后保留 `1784` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 46 | 13 | 50 | 286 | 33 | 25 | 21 | 21 | 13 | 21 | 5 | 9 | 7 | 9 | 112 | 5 | 5 | 1103 | **1784** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-01 21:38:05`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1237** 个 | `53.57%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.69%` |
| 3 | `📡 Zhangkai 系列` | **194** 个 | `8.40%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `2.25%` |
| 5 | `[长效备份] hysteria2 节点` | **52** 个 | `2.25%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `1.86%` |
| 7 | `📡 shaoyouvip 每日更新` | **22** 个 | `0.95%` |
...
| 16 | `📱 Pawdroid 免费节点库` | **11** 个 | `0.48%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.43%` |
| 18 | `[长效备份] hy2 节点` | **5** 个 | `0.22%` |
| **-** | **总计 (包含跨源重合)** | **2309** 个 | `100.00%` |
