...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-04--13%3A54%3A28-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1816-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-04 13:54:28`
> 运行分析：从 `19` 个活跃源中抓取 `2479` 个节点，耗时 `3.06s`。去重后保留 `1816` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇵🇱波兰 | 🇦🇪阿联酋 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 55 | 11 | 63 | 260 | 60 | 32 | 26 | 17 | 13 | 15 | 9 | 4 | 7 | 8 | 4 | 67 | 6 | 5 | 1154 | **1816** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-04 13:54:28`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1345** 个 | `54.90%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `22.33%` |
| 3 | `📡 Zhangkai 系列` | **92** 个 | `3.76%` |
| 4 | `📡 shaoyouvip 每日更新` | **70** 个 | `2.86%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **67** 个 | `2.73%` |
| 6 | `[长效备份] hysteria2 节点` | **45** 个 | `1.84%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.76%` |
...
| 16 | `📱 Pawdroid 免费节点库` | **14** 个 | `0.57%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.41%` |
| 18 | `[长效备份] hy2 节点` | **9** 个 | `0.37%` |
| **-** | **总计 (包含跨源重合)** | **2450** 个 | `100.00%` |
