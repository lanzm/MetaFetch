...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-18--11%3A48%3A49-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2124-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-18 11:48:49`
> 运行分析：从 `19` 个活跃源中抓取 `2762` 个节点，耗时 `3.84s`。去重后保留 `2124` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 61 | 15 | 46 | 322 | 36 | 27 | 27 | 31 | 32 | 5 | 5 | 28 | 4 | 11 | 8 | 96 | 9 | 6 | 9 | 7 | 5 | 1334 | **2124** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-18 11:48:50`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1514** 个 | `55.40%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.01%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.82%` |
| 4 | `[长效备份] hysteria2 节点` | **133** 个 | `4.87%` |
| 5 | `📡 shaoyouvip 每日更新` | **95** 个 | `3.48%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **51** 个 | `1.87%` |
| 7 | `[长效备份] hy2 节点` | **49** 个 | `1.79%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.57%` |
