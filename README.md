...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-30--06%3A04%3A34-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1686-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-30 06:04:34`
> 运行分析：从 `19` 个活跃源中抓取 `2228` 个节点，耗时 `3.39s`。去重后保留 `1686` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 12 | 45 | 245 | 34 | 26 | 27 | 20 | 19 | 13 | 6 | 7 | 4 | 14 | 8 | 106 | 6 | 1047 | **1686** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-30 06:04:35`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1127** 个 | `51.37%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `24.93%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `4.56%` |
| 4 | `📡 Zhangkai 系列` | **84** 个 | `3.83%` |
| 5 | `[长效备份] hysteria2 节点` | **53** 个 | `2.42%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **46** 个 | `2.10%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.96%` |
...
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.46%` |
| 17 | `📱 Pawdroid 免费节点库` | **7** 个 | `0.32%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.09%` |
| **-** | **总计 (包含跨源重合)** | **2194** 个 | `100.00%` |
