...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-24--02%3A35%3A35-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2239-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-24 02:35:35`
> 运行分析：从 `19` 个活跃源中抓取 `2914` 个节点，耗时 `2.45s`。去重后保留 `2239` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 72 | 14 | 53 | 288 | 43 | 27 | 29 | 29 | 17 | 20 | 5 | 26 | 5 | 6 | 19 | 8 | 18 | 120 | 5 | 4 | 9 | 4 | 1418 | **2239** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1648** 个 | `57.06%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `19.04%` |
| 3 | `📡 Zhangkai 系列` | **144** 个 | `4.99%` |
| 4 | `📡 shaoyouvip 每日更新` | **90** 个 | `3.12%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **87** 个 | `3.01%` |
| 6 | `[长效备份] hy2 节点` | **62** 个 | `2.15%` |
| 7 | `[长效备份] hysteria2 节点` | **51** 个 | `1.77%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.49%` |
| 9 | `[动态日期] NodeFree TXT` | **25** 个 | `0.87%` |
| 10 | `[动态日期] v2rayShare TXT` | **25** 个 | `0.87%` |
| 11 | `[动态日期] oneClash TXT` | **25** 个 | `0.87%` |
...
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.35%` |
| 19 | `我的私密机场 1` | **7** 个 | `0.24%` |
| **-** | **总计 (包含跨源重合)** | **2888** 个 | `100.00%` |
