...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-16--20%3A48%3A22-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2021-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-16 20:48:22`
> 运行分析：从 `19` 个活跃源中抓取 `2614` 个节点，耗时 `3.81s`。去重后保留 `2021` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 51 | 12 | 43 | 299 | 35 | 25 | 20 | 35 | 20 | 9 | 28 | 4 | 10 | 7 | 97 | 6 | 4 | 10 | 7 | 1299 | **2021** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-16 20:48:23`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1470** 个 | `56.84%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.15%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.15%` |
| 4 | `[长效备份] hysteria2 节点` | **87** 个 | `3.36%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **57** 个 | `2.20%` |
| 6 | `[长效备份] hy2 节点` | **55** 个 | `2.13%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.66%` |
| 8 | `📡 shaoyouvip 每日更新` | **26** 个 | `1.01%` |
