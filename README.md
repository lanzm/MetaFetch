...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-13--08%3A16%3A32-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-968-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-13 08:16:32`
> 运行分析：从 `10` 个活跃源中抓取 `1153` 个节点，耗时 `2.22s`。去重后保留 `968` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 12 | 50 | 256 | 36 | 25 | 27 | 20 | 19 | 4 | 3 | 21 | 4 | 4 | 10 | 6 | 1 | 4 | 2 | 1 | 1 | 9 | 13 | 127 | 8 | 3 | 6 | 6 | 1 | 5 | 4 | 1 | 4 | 1 | 2 | 1 | 1 | 1 | 229 | **968** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `48.33%` |
| 2 | `[长效备份] hysteria2 节点` | **172** 个 | `15.11%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.65%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `8.79%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **59** 个 | `5.18%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.78%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.16%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.23%` |
| 9 | `📱 Pawdroid 免费节点库` | **13** 个 | `1.14%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.62%` |
| **-** | **总计 (包含跨源重合)** | **1138** 个 | `100.00%` |
