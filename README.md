...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-18--14%3A51%3A18-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2080-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-18 14:51:18`
> 运行分析：从 `19` 个活跃源中抓取 `2712` 个节点，耗时 `3.80s`。去重后保留 `2080` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 56 | 12 | 47 | 304 | 40 | 29 | 22 | 28 | 21 | 8 | 4 | 25 | 4 | 11 | 7 | 94 | 7 | 6 | 8 | 7 | 1340 | **2080** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-18 14:51:19`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1514** 个 | `56.43%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.39%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.93%` |
| 4 | `[长效备份] hysteria2 节点` | **129** 个 | `4.81%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `2.39%` |
| 6 | `[长效备份] hy2 节点` | **50** 个 | `1.86%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.60%` |
| 8 | `📡 shaoyouvip 每日更新` | **35** 个 | `1.30%` |
| 9 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.75%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.52%` |
