...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-27--03%3A18%3A40-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1601-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-27 03:18:40`
> 运行分析：从 `19` 个活跃源中抓取 `2065` 个节点，耗时 `3.51s`。去重后保留 `1601` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 14 | 50 | 239 | 34 | 23 | 21 | 17 | 16 | 12 | 5 | 4 | 13 | 7 | 78 | 1019 | **1601** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-27 03:18:41`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1043** 个 | `51.35%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.93%` |
| 3 | `📡 Zhangkai 系列` | **86** 个 | `4.23%` |
| 4 | `[长效备份] hysteria2 节点` | **58** 个 | `2.86%` |
...
| 15 | `[长效备份] peasoft 精选` | **10** 个 | `0.49%` |
| 16 | `📱 Pawdroid 免费节点库` | **9** 个 | `0.44%` |
| 17 | `[长效备份] hy2 节点` | **8** 个 | `0.39%` |
| 18 | `📡 shaoyouvip 每日更新` | **8** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2031** 个 | `100.00%` |
