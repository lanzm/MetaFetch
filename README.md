...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-12--03%3A07%3A22-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1927-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-12 03:07:22`
> 运行分析：从 `19` 个活跃源中抓取 `2495` 个节点，耗时 `3.64s`。去重后保留 `1927` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 11 | 45 | 297 | 35 | 26 | 20 | 31 | 20 | 6 | 4 | 25 | 4 | 8 | 8 | 98 | 7 | 4 | 4 | 6 | 1220 | **1927** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-12 03:07:24`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1405** 个 | `56.97%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `22.18%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.45%` |
| 4 | `[长效备份] hy2 节点` | **73** 个 | `2.96%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `1.91%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `1.74%` |
| 7 | `[长效备份] hysteria2 节点` | **41** 个 | `1.66%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.81%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.57%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.57%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.57%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.57%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.57%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.57%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.57%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.57%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.41%` |
| 18 | `📡 shaoyouvip 每日更新` | **9** 个 | `0.36%` |
| **-** | **总计 (包含跨源重合)** | **2466** 个 | `100.00%` |
