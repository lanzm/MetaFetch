...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--01%3A02%3A14-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 01:02:14`
> 运行分析：从 `19` 个活跃源中抓取 `1020` 个节点，耗时 `2.78s`。去重后保留 `767` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 45 | 11 | 47 | 221 | 34 | 25 | 18 | 10 | 14 | 4 | 4 | 6 | 13 | 8 | 60 | 247 | **767** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 01:02:14`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `55.14%` |
| 2 | `[长效备份] hysteria2 节点` | **84** 个 | `8.47%` |
| 3 | `📡 Zhangkai 系列` | **74** 个 | `7.46%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `4.44%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.33%` |
| 6 | `[动态日期] NodeFree TXT` | **25** 个 | `2.52%` |
| 7 | `[动态日期] v2rayShare TXT` | **25** 个 | `2.52%` |
| 8 | `[动态日期] oneClash TXT` | **25** 个 | `2.52%` |
| 9 | `[动态日期] NodeFree YAML` | **24** 个 | `2.42%` |
| 10 | `[动态日期] v2rayShare YAML` | **24** 个 | `2.42%` |
| 11 | `[动态日期] oneClash YAML` | **24** 个 | `2.42%` |
| 12 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.41%` |
| 13 | `📡 FreeFQ 每日福利` | **14** 个 | `1.41%` |
| 14 | `[长效备份] peasoft 精选` | **10** 个 | `1.01%` |
| 15 | `📱 Pawdroid 免费节点库` | **9** 个 | `0.91%` |
| 16 | `📡 shaoyouvip 每日更新` | **4** 个 | `0.40%` |
| 17 | `[长效备份] hy2 节点` | **2** 个 | `0.20%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **992** 个 | `100.00%` |
