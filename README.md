...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-06--19%3A27%3A28-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1769-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-06 19:27:28`
> 运行分析：从 `19` 个活跃源中抓取 `2473` 个节点，耗时 `3.55s`。去重后保留 `1769` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 12 | 45 | 246 | 34 | 25 | 30 | 27 | 19 | 15 | 4 | 15 | 6 | 11 | 8 | 4 | 16 | 5 | 5 | 1192 | **1769** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-06 19:27:30`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1383** 个 | `56.59%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `22.38%` |
| 3 | `[长效备份] hysteria2 节点` | **81** 个 | `3.31%` |
...
| 14 | `📡 shaoyouvip 每日更新` | **22** 个 | `0.90%` |
| 15 | `📱 Pawdroid 免费节点库` | **16** 个 | `0.65%` |
| 16 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.57%` |
| 17 | `📡 FreeFQ 每日福利` | **14** 个 | `0.57%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.41%` |
| **-** | **总计 (包含跨源重合)** | **2444** 个 | `100.00%` |
