...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-06--04%3A41%3A59-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-969-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-06 04:41:59`
> 运行分析：从 `10` 个活跃源中抓取 `1087` 个节点，耗时 `2.34s`。去重后保留 `969` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 11 | 46 | 269 | 34 | 27 | 29 | 22 | 17 | 5 | 4 | 18 | 4 | 4 | 11 | 5 | 1 | 3 | 4 | 1 | 1 | 10 | 14 | 122 | 13 | 4 | 4 | 6 | 1 | 6 | 2 | 2 | 2 | 1 | 1 | 1 | 223 | **969** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `51.31%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.43%` |
| 3 | `[长效备份] hysteria2 节点` | **131** 个 | `12.22%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.33%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.01%` |
| 6 | `[长效备份] hy2 节点` | **34** 个 | `3.17%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **29** 个 | `2.71%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.87%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.31%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.65%` |
| **-** | **总计 (包含跨源重合)** | **1072** 个 | `100.00%` |
