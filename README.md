...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-02--00%3A04%3A24-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-859-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-02 00:04:24`
> 运行分析：从 `19` 个活跃源中抓取 `1097` 个节点，耗时 `3.29s`。去重后保留 `859` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 42 | 13 | 46 | 267 | 33 | 26 | 16 | 15 | 13 | 15 | 4 | 9 | 9 | 7 | 112 | 5 | 4 | 223 | **859** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-02 00:04:25`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `51.46%` |
| 2 | `📡 Zhangkai 系列` | **194** 个 | `18.25%` |
| 3 | `[长效备份] hysteria2 节点` | **57** 个 | `5.36%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `4.89%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.05%` |
| 6 | `[动态日期] NodeFree YAML` | **20** 个 | `1.88%` |
| 7 | `[动态日期] v2rayShare YAML` | **20** 个 | `1.88%` |
| 8 | `[动态日期] oneClash YAML` | **20** 个 | `1.88%` |
| 9 | `[动态日期] NodeFree TXT` | **16** 个 | `1.51%` |
| 10 | `[动态日期] v2rayShare TXT` | **16** 个 | `1.51%` |
| 11 | `[动态日期] oneClash TXT` | **16** 个 | `1.51%` |
| 12 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.32%` |
| 13 | `📡 FreeFQ 每日福利` | **14** 个 | `1.32%` |
| 14 | `📱 Pawdroid 免费节点库` | **13** 个 | `1.22%` |
| 15 | `[长效备份] peasoft 精选` | **10** 个 | `0.94%` |
| 16 | `📡 shaoyouvip 每日更新` | **6** 个 | `0.56%` |
| 17 | `[长效备份] hy2 节点` | **5** 个 | `0.47%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1063** 个 | `100.00%` |
