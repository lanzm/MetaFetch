...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--06%3A11%3A33-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1647-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 06:11:33`
> 运行分析：从 `19` 个活跃源中抓取 `2133` 个节点，耗时 `3.51s`。去重后保留 `1647` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇦🇹奥地利 | 🇺🇦乌克兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 11 | 46 | 248 | 33 | 25 | 26 | 16 | 16 | 15 | 4 | 5 | 14 | 9 | 4 | 107 | 5 | 4 | 4 | 1007 | **1647** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 06:11:34`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `50.17%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.06%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `4.76%` |
| 4 | `📡 Zhangkai 系列` | **74** 个 | `3.53%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `2.10%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.05%` |
| 7 | `[长效备份] hysteria2 节点` | **42** 个 | `2.00%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.19%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.19%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.19%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.14%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.14%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.14%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.67%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.67%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.48%` |
| 17 | `📱 Pawdroid 免费节点库` | **9** 个 | `0.43%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2099** 个 | `100.00%` |
