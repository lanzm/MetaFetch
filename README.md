...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-23--21%3A50%3A16-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-848-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-23 21:50:16`
> 运行分析：从 `10` 个活跃源中抓取 `1002` 个节点，耗时 `2.43s`。去重后保留 `848` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 43 | 240 | 32 | 25 | 19 | 16 | 12 | 5 | 3 | 17 | 1 | 3 | 7 | 2 | 1 | 1 | 1 | 2 | 7 | 13 | 119 | 3 | 2 | 8 | 3 | 2 | 3 | 2 | 1 | 2 | 1 | 1 | 1 | 199 | **848** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `55.61%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `14.56%` |
| 3 | `[长效备份] hysteria2 节点` | **107** 个 | `10.82%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.66%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.35%` |
| 6 | `📡 shaoyouvip 每日更新` | **36** 个 | `3.64%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.02%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.42%` |
| 9 | `[长效备份] hy2 节点` | **12** 个 | `1.21%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.71%` |
| **-** | **总计 (包含跨源重合)** | **989** 个 | `100.00%` |
