...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-26--00%3A07%3A41-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-806-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-26 00:07:41`
> 运行分析：从 `19` 个活跃源中抓取 `1082` 个节点，耗时 `2.89s`。去重后保留 `806` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 14 | 48 | 225 | 37 | 24 | 19 | 14 | 17 | 10 | 4 | 19 | 15 | 7 | 78 | 5 | 4 | 4 | 213 | **806** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-26 00:07:41`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `51.90%` |
| 2 | `📡 Zhangkai 系列` | **119** 个 | `11.29%` |
| 3 | `[长效备份] hysteria2 节点` | **79** 个 | `7.50%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **43** 个 | `4.08%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.08%` |
| 6 | `[动态日期] NodeFree TXT` | **25** 个 | `2.37%` |
| 7 | `[动态日期] v2rayShare TXT` | **25** 个 | `2.37%` |
| 8 | `[动态日期] oneClash TXT` | **25** 个 | `2.37%` |
| 9 | `[动态日期] NodeFree YAML` | **24** 个 | `2.28%` |
| 10 | `[动态日期] v2rayShare YAML` | **24** 个 | `2.28%` |
| 11 | `[动态日期] oneClash YAML` | **24** 个 | `2.28%` |
| 12 | `📡 shaoyouvip 每日更新` | **18** 个 | `1.71%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.33%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `1.33%` |
| 15 | `📱 Pawdroid 免费节点库` | **12** 个 | `1.14%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.95%` |
| 17 | `[长效备份] hy2 节点` | **8** 个 | `0.76%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1054** 个 | `100.00%` |
