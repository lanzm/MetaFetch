...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-26--16%3A58%3A54-green.svg?style=flat-square)
...
> 运行分析：从 `9` 个活跃源中抓取 `921` 个节点，耗时 `15.14s`。去重后保留 `841` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇹🇭泰国 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 43 | 12 | 38 | 236 | 34 | 23 | 18 | 18 | 14 | 4 | 6 | 17 | 2 | 4 | 14 | 2 | 1 | 2 | 2 | 1 | 1 | 7 | 6 | 119 | 4 | 2 | 3 | 4 | 3 | 2 | 1 | 4 | 2 | 3 | 1 | 188 | **841** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `60.57%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `15.86%` |
| 3 | `[长效备份] hysteria2 节点` | **69** 个 | `7.60%` |
| 4 | `[长效备份] hy2 节点` | **54** 个 | `5.95%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.74%` |
| 6 | `📱 Pawdroid 免费节点库` | **20** 个 | `2.20%` |
| 7 | `📡 shaoyouvip 每日更新` | **14** 个 | `1.54%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.54%` |
| 9 | `⚡ Misaka Chromego 聚合池` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **908** 个 | `100.00%` |
