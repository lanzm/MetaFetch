...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-11--00%3A39%3A26-green.svg?style=flat-square)
...
> 运行分析：从 `10` 个活跃源中抓取 `1058` 个节点，耗时 `2.05s`。去重后保留 `896` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 45 | 234 | 36 | 28 | 21 | 16 | 15 | 5 | 4 | 15 | 1 | 4 | 11 | 7 | 1 | 3 | 4 | 1 | 10 | 14 | 120 | 9 | 2 | 3 | 2 | 4 | 3 | 2 | 2 | 1 | 1 | 222 | **896** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.73%` |
| 2 | `[长效备份] hysteria2 节点` | **169** 个 | `16.20%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.81%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `4.99%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.12%` |
| 6 | `[长效备份] hy2 节点` | **34** 个 | `3.26%` |
| 7 | `📱 Pawdroid 免费节点库` | **18** 个 | `1.73%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.34%` |
| 9 | `📡 shaoyouvip 每日更新` | **12** 个 | `1.15%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.67%` |
| **-** | **总计 (包含跨源重合)** | **1043** 个 | `100.00%` |
