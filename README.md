...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-29--19%3A29%3A29-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1665-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-29 19:29:29`
> 运行分析：从 `19` 个活跃源中抓取 `2187` 个节点，耗时 `3.47s`。去重后保留 `1665` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇦🇪阿联酋 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 11 | 45 | 279 | 35 | 24 | 22 | 19 | 30 | 13 | 4 | 13 | 7 | 94 | 4 | 4 | 1014 | **1665** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-29 19:29:30`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1076** 个 | `49.98%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `25.41%` |
| 3 | `📡 Zhangkai 系列` | **167** 个 | `7.76%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **66** 个 | `3.07%` |
| 5 | `[长效备份] hysteria2 节点` | **46** 个 | `2.14%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.00%` |
| 7 | `[动态日期] NodeFree TXT` | **25** 个 | `1.16%` |
| 8 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.16%` |
| 9 | `[动态日期] oneClash TXT` | **25** 个 | `1.16%` |
| 10 | `[动态日期] NodeFree YAML` | **24** 个 | `1.11%` |
| 11 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.11%` |
| 12 | `[动态日期] oneClash YAML` | **24** 个 | `1.11%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.65%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.65%` |
| 15 | `📡 shaoyouvip 每日更新` | **11** 个 | `0.51%` |
| 16 | `📱 Pawdroid 免费节点库` | **10** 个 | `0.46%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.46%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.09%` |
| **-** | **总计 (包含跨源重合)** | **2153** 个 | `100.00%` |
