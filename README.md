...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-29--22%3A21%3A13-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1604-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-29 22:21:13`
> 运行分析：从 `19` 个活跃源中抓取 `2128` 个节点，耗时 `2.82s`。去重后保留 `1604` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 12 | 45 | 249 | 34 | 25 | 22 | 17 | 17 | 13 | 4 | 5 | 4 | 13 | 8 | 71 | 4 | 1014 | **1604** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-29 22:21:14`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1076** 个 | `51.38%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.12%` |
| 3 | `[长效备份] hysteria2 节点` | **88** 个 | `4.20%` |
| 4 | `📡 Zhangkai 系列` | **84** 个 | `4.01%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `2.67%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.05%` |
| 7 | `[动态日期] NodeFree TXT` | **25** 个 | `1.19%` |
| 8 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.19%` |
| 9 | `[动态日期] oneClash TXT` | **25** 个 | `1.19%` |
| 10 | `[动态日期] NodeFree YAML` | **24** 个 | `1.15%` |
| 11 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.15%` |
| 12 | `[动态日期] oneClash YAML` | **24** 个 | `1.15%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.67%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.67%` |
| 15 | `📱 Pawdroid 免费节点库` | **10** 个 | `0.48%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.48%` |
| 17 | `📡 shaoyouvip 每日更新` | **3** 个 | `0.14%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2094** 个 | `100.00%` |
