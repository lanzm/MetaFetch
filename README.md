...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-09--21%3A00%3A23-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-09 21:00:23`
> 运行分析：从 `19` 个活跃源中抓取 `2470` 个节点，耗时 `3.16s`。去重后保留 `1816` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 11 | 45 | 257 | 35 | 27 | 32 | 22 | 21 | 13 | 18 | 5 | 4 | 8 | 9 | 19 | 6 | 5 | 5 | 1225 | **1816** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-09 21:00:23`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1405** 个 | `57.58%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `22.42%` |
| 3 | `[长效备份] hysteria2 节点` | **81** 个 | `3.32%` |
| 4 | `[长效备份] hy2 节点` | **64** 个 | `2.62%` |
...
| 12 | `📡 Zhangkai 系列` | **25** 个 | `1.02%` |
| 13 | `📡 shaoyouvip 每日更新` | **23** 个 | `0.94%` |
| 14 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.82%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.57%` |
| 16 | `⚡ Misaka Chromego 聚合池` | **14** 个 | `0.57%` |
| 17 | `📡 FreeFQ 每日福利` | **14** 个 | `0.57%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.41%` |
| **-** | **总计 (包含跨源重合)** | **2440** 个 | `100.00%` |
