...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-01--11%3A25%3A41-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1781-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-01 11:25:41`
> 运行分析：从 `19` 个活跃源中抓取 `2345` 个节点，耗时 `2.98s`。去重后保留 `1781` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 56 | 11 | 47 | 273 | 35 | 24 | 31 | 25 | 18 | 16 | 4 | 13 | 4 | 10 | 7 | 90 | 10 | 7 | 1100 | **1781** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-01 11:25:42`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1237** 个 | `53.67%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.73%` |
| 3 | `📡 Zhangkai 系列` | **110** 个 | `4.77%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `4.34%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `2.43%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `1.87%` |
| 7 | `[长效备份] hysteria2 节点` | **42** 个 | `1.82%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.87%` |
| 9 | `[动态日期] NodeFree YAML` | **20** 个 | `0.87%` |
| 10 | `[动态日期] v2rayShare YAML` | **20** 个 | `0.87%` |
| 11 | `[动态日期] oneClash YAML` | **20** 个 | `0.87%` |
| 12 | `[动态日期] NodeFree TXT` | **16** 个 | `0.69%` |
| 13 | `[动态日期] v2rayShare TXT` | **16** 个 | `0.69%` |
| 14 | `[动态日期] oneClash TXT` | **16** 个 | `0.69%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.61%` |
| 16 | `📡 FreeFQ 每日福利` | **14** 个 | `0.61%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.43%` |
| 18 | `[长效备份] hy2 节点` | **4** 个 | `0.17%` |
| **-** | **总计 (包含跨源重合)** | **2305** 个 | `100.00%` |
