...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-14--00%3A01%3A50-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-930-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-14 00:01:50`
> 运行分析：从 `19` 个活跃源中抓取 `1179` 个节点，耗时 `2.77s`。去重后保留 `930` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 11 | 45 | 289 | 36 | 24 | 28 | 29 | 21 | 4 | 26 | 4 | 9 | 8 | 9 | 98 | 4 | 4 | 4 | 228 | **930** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-14 00:01:50`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `47.28%` |
| 2 | `📡 Zhangkai 系列` | **159** 个 | `13.74%` |
| 3 | `[长效备份] hysteria2 节点` | **71** 个 | `6.14%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `4.67%` |
| 5 | `[长效备份] hy2 节点` | **50** 个 | `4.32%` |
| 6 | `📡 shaoyouvip 每日更新` | **49** 个 | `4.24%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `3.72%` |
| 8 | `[动态日期] NodeFree YAML` | **28** 个 | `2.42%` |
| 9 | `[动态日期] v2rayShare YAML` | **28** 个 | `2.42%` |
| 10 | `[动态日期] oneClash YAML` | **28** 个 | `2.42%` |
| 11 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.73%` |
| 12 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.21%` |
| 13 | `📡 FreeFQ 每日福利` | **14** 个 | `1.21%` |
| 14 | `[动态日期] NodeFree TXT` | **14** 个 | `1.21%` |
| 15 | `[动态日期] v2rayShare TXT` | **14** 个 | `1.21%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `1.21%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.86%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1157** 个 | `100.00%` |
