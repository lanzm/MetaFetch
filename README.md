...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-13--10%3A22%3A13-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2023-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-13 10:22:13`
> 运行分析：从 `19` 个活跃源中抓取 `2621` 个节点，耗时 `4.01s`。去重后保留 `2023` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 52 | 12 | 44 | 304 | 35 | 25 | 29 | 32 | 25 | 5 | 27 | 4 | 9 | 10 | 131 | 10 | 4 | 5 | 1260 | **2023** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-13 10:22:15`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1420** 个 | `54.76%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.10%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.13%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `3.90%` |
| 5 | `[长效备份] hysteria2 节点` | **72** 个 | `2.78%` |
| 6 | `[长效备份] hy2 节点` | **57** 个 | `2.20%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `2.01%` |
