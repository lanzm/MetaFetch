...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-13--05%3A51%3A45-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2019-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-13 05:51:45`
> 运行分析：从 `19` 个活跃源中抓取 `2631` 个节点，耗时 `3.17s`。去重后保留 `2019` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 12 | 46 | 308 | 34 | 26 | 27 | 33 | 24 | 5 | 4 | 24 | 4 | 9 | 11 | 127 | 11 | 5 | 4 | 4 | 1253 | **2019** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-13 05:51:46`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1420** 个 | `54.55%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.01%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.11%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.84%` |
| 5 | `[长效备份] hysteria2 节点` | **80** 个 | `3.07%` |
| 6 | `[长效备份] hy2 节点` | **66** 个 | `2.54%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **46** 个 | `1.77%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.65%` |
| 9 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.77%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.54%` |
| 11 | `📡 FreeFQ 每日福利` | **14** 个 | `0.54%` |
| 12 | `[动态日期] NodeFree TXT` | **14** 个 | `0.54%` |
| 13 | `[动态日期] NodeFree YAML` | **14** 个 | `0.54%` |
| 14 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.54%` |
| 15 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.54%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `0.54%` |
| 17 | `[动态日期] oneClash YAML` | **14** 个 | `0.54%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.38%` |
| **-** | **总计 (包含跨源重合)** | **2603** 个 | `100.00%` |
