...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-16--11%3A51%3A50-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2068-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-16 11:51:50`
> 运行分析：从 `19` 个活跃源中抓取 `2660` 个节点，耗时 `3.82s`。去重后保留 `2068` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 60 | 11 | 44 | 307 | 38 | 24 | 22 | 35 | 24 | 8 | 4 | 30 | 4 | 12 | 7 | 116 | 5 | 6 | 9 | 1302 | **2068** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-16 11:51:52`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1470** 个 | `55.85%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.78%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.04%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.80%` |
| 5 | `[长效备份] hysteria2 节点` | **62** 个 | `2.36%` |
| 6 | `[长效备份] hy2 节点` | **58** 个 | `2.20%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **51** 个 | `1.94%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.63%` |
