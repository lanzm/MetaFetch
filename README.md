...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-21--20%3A56%3A08-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-21 20:56:08`
> 运行分析：从 `19` 个活跃源中抓取 `2772` 个节点，耗时 `2.35s`。去重后保留 `2149` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇻🇳越南 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 55 | 14 | 55 | 265 | 40 | 32 | 29 | 24 | 19 | 18 | 5 | 6 | 27 | 6 | 15 | 10 | 6 | 124 | 6 | 5 | 4 | 5 | 1379 | **2149** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1609** 个 | `58.51%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `20.00%` |
| 3 | `📡 Zhangkai 系列` | **144** 个 | `5.24%` |
| 4 | `[长效备份] hysteria2 节点` | **61** 个 | `2.22%` |
| 5 | `📡 shaoyouvip 每日更新` | **58** 个 | `2.11%` |
| 6 | `[长效备份] hy2 节点` | **50** 个 | `1.82%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.56%` |
| 8 | `[动态日期] NodeFree YAML` | **30** 个 | `1.09%` |
| 9 | `[动态日期] v2rayShare YAML` | **30** 个 | `1.09%` |
| 10 | `[动态日期] oneClash YAML` | **30** 个 | `1.09%` |
| 11 | `[动态日期] NodeFree TXT` | **23** 个 | `0.84%` |
| 12 | `[动态日期] v2rayShare TXT` | **23** 个 | `0.84%` |
| 13 | `[动态日期] oneClash TXT` | **23** 个 | `0.84%` |
| 14 | `📱 Pawdroid 免费节点库` | **16** 个 | `0.58%` |
