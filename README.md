...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-18--02%3A46%3A16-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2116-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-18 02:46:16`
> 运行分析：从 `19` 个活跃源中抓取 `2749` 个节点，耗时 `3.95s`。去重后保留 `2116` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 58 | 17 | 49 | 303 | 48 | 33 | 24 | 30 | 21 | 8 | 4 | 29 | 4 | 14 | 7 | 92 | 21 | 6 | 9 | 8 | 1331 | **2116** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-18 02:46:18`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1514** 个 | `55.66%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.11%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.85%` |
| 4 | `[长效备份] hysteria2 节点` | **147** 个 | `5.40%` |
| 5 | `📡 shaoyouvip 每日更新` | **73** 个 | `2.68%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `1.91%` |
| 7 | `[长效备份] hy2 节点` | **52** 个 | `1.91%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.58%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.51%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.51%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.51%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.51%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.51%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.51%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.51%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.51%` |
| 17 | `📱 Pawdroid 免费节点库` | **11** 个 | `0.40%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.37%` |
| **-** | **总计 (包含跨源重合)** | **2720** 个 | `100.00%` |
