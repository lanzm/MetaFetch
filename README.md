...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-11--12%3A23%3A19-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-11 12:23:19`
> 运行分析：从 `19` 个活跃源中抓取 `2392` 个节点，耗时 `3.07s`。去重后保留 `1836` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇧🇷巴西 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 11 | 49 | 237 | 38 | 26 | 20 | 28 | 39 | 9 | 21 | 4 | 8 | 4 | 8 | 4 | 51 | 6 | 5 | 1218 | **1836** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-11 12:23:20`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1348** 个 | `57.05%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.15%` |
| 3 | `[长效备份] hy2 节点` | **68** 个 | `2.88%` |
| 4 | `📡 Zhangkai 系列` | **67** 个 | `2.84%` |
| 5 | `📡 shaoyouvip 每日更新` | **60** 个 | `2.54%` |
| 6 | `[长效备份] hysteria2 节点` | **50** 个 | `2.12%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.82%` |
| 8 | `⚡ Misaka Chromego 聚合池` | **38** 个 | `1.61%` |
| 9 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.85%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.59%` |
| 11 | `📡 FreeFQ 每日福利` | **14** 个 | `0.59%` |
| 12 | `[动态日期] NodeFree TXT` | **14** 个 | `0.59%` |
| 13 | `[动态日期] NodeFree YAML` | **14** 个 | `0.59%` |
| 14 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.59%` |
| 15 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.59%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `0.59%` |
| 17 | `[动态日期] oneClash YAML` | **14** 个 | `0.59%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.42%` |
| **-** | **总计 (包含跨源重合)** | **2363** 个 | `100.00%` |
