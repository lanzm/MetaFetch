...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-13--00%3A01%3A28-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-13 00:01:28`
> 运行分析：从 `19` 个活跃源中抓取 `1128` 个节点，耗时 `3.07s`。去重后保留 `891` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 11 | 47 | 270 | 35 | 27 | 21 | 26 | 20 | 5 | 4 | 23 | 4 | 9 | 10 | 97 | 10 | 4 | 4 | 215 | **891** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-13 00:01:28`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `49.46%` |
| 2 | `📡 Zhangkai 系列` | **159** 个 | `14.38%` |
| 3 | `[长效备份] hysteria2 节点` | **97** 个 | `8.77%` |
| 4 | `[长效备份] hy2 节点` | **67** 个 | `6.06%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **48** 个 | `4.34%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.89%` |
| 7 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.81%` |
| 8 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.27%` |
| 9 | `📡 FreeFQ 每日福利` | **14** 个 | `1.27%` |
| 10 | `[动态日期] NodeFree TXT` | **14** 个 | `1.27%` |
| 11 | `[动态日期] NodeFree YAML` | **14** 个 | `1.27%` |
| 12 | `[动态日期] v2rayShare TXT` | **14** 个 | `1.27%` |
| 13 | `[动态日期] v2rayShare YAML` | **14** 个 | `1.27%` |
| 14 | `[动态日期] oneClash TXT` | **14** 个 | `1.27%` |
| 15 | `[动态日期] oneClash YAML` | **14** 个 | `1.27%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.90%` |
| 17 | `📡 shaoyouvip 每日更新` | **3** 个 | `0.27%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1106** 个 | `100.00%` |
