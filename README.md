...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-12--15%3A39%3A27-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1937-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-12 15:39:27`
> 运行分析：从 `19` 个活跃源中抓取 `2522` 个节点，耗时 `3.39s`。去重后保留 `1937` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 12 | 47 | 297 | 33 | 26 | 23 | 30 | 20 | 7 | 24 | 4 | 7 | 9 | 97 | 7 | 5 | 4 | 1237 | **1937** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-12 15:39:28`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1405** 个 | `56.36%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.94%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.38%` |
| 4 | `[长效备份] hysteria2 节点` | **73** 个 | `2.93%` |
| 5 | `[长效备份] hy2 节点` | **64** 个 | `2.57%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **48** 个 | `1.93%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.72%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.80%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.56%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.56%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.56%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.56%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.56%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.56%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.56%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.56%` |
| 17 | `📡 shaoyouvip 每日更新` | **12** 个 | `0.48%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.40%` |
| **-** | **总计 (包含跨源重合)** | **2493** 个 | `100.00%` |
