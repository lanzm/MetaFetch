...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--22%3A21%3A03-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 22:21:03`
> 运行分析：从 `19` 个活跃源中抓取 `2100` 个节点，耗时 `3.52s`。去重后保留 `1614` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 53 | 13 | 50 | 251 | 36 | 29 | 25 | 16 | 14 | 12 | 4 | 13 | 7 | 4 | 70 | 1017 | **1614** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 22:21:04`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `50.97%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.48%` |
| 3 | `📡 Zhangkai 系列` | **81** 个 | `3.92%` |
| 4 | `[长效备份] hysteria2 节点` | **54** 个 | `2.61%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `2.27%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.08%` |
| 7 | `📡 shaoyouvip 每日更新` | **37** 个 | `1.79%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.21%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.21%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.21%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.16%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.16%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.16%` |
| 14 | `📱 Pawdroid 免费节点库` | **17** 个 | `0.82%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.68%` |
| 16 | `📡 FreeFQ 每日福利` | **14** 个 | `0.68%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.48%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2066** 个 | `100.00%` |
