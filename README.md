...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-25--11%3A14%3A06-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1578-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-25 11:14:06`
> 运行分析：从 `19` 个活跃源中抓取 `2052` 个节点，耗时 `3.50s`。去重后保留 `1578` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇮🇩印尼 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇺🇦乌克兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 14 | 47 | 242 | 36 | 24 | 23 | 22 | 17 | 12 | 12 | 4 | 13 | 5 | 8 | 72 | 6 | 4 | 4 | 965 | **1578** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-25 11:14:07`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **971** 个 | `48.12%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `27.11%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `4.96%` |
| 4 | `📡 Zhangkai 系列` | **61** 个 | `3.02%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **53** 个 | `2.63%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.13%` |
| 7 | `[长效备份] hysteria2 节点` | **37** 个 | `1.83%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.24%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.24%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.24%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.19%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.19%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.19%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.69%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.69%` |
| 16 | `📱 Pawdroid 免费节点库` | **13** 个 | `0.64%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.50%` |
| 18 | `[长效备份] hy2 节点` | **8** 个 | `0.40%` |
| **-** | **总计 (包含跨源重合)** | **2018** 个 | `100.00%` |
