...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-11--05%3A46%3A57-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1783-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-11 05:46:57`
> 运行分析：从 `19` 个活跃源中抓取 `2332` 个节点，耗时 `2.48s`。去重后保留 `1783` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 11 | 46 | 230 | 33 | 26 | 17 | 27 | 22 | 7 | 20 | 4 | 9 | 8 | 4 | 51 | 5 | 1216 | **1783** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-11 05:46:58`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1348** 个 | `58.53%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.75%` |
| 3 | `[长效备份] hy2 节点` | **68** 个 | `2.95%` |
| 4 | `📡 Zhangkai 系列` | **67** 个 | `2.91%` |
| 5 | `[长效备份] hysteria2 节点` | **46** 个 | `2.00%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `1.87%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **38** 个 | `1.65%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.87%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.61%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.61%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.61%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.61%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.61%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.61%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.61%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.61%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.43%` |
| 18 | `📡 shaoyouvip 每日更新` | **4** 个 | `0.17%` |
| **-** | **总计 (包含跨源重合)** | **2303** 个 | `100.00%` |
