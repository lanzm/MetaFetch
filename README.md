...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-12--19%3A13%3A44-green.svg?style=flat-square)
...
> 运行分析：从 `10` 个活跃源中抓取 `1098` 个节点，耗时 `2.23s`。去重后保留 `907` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 46 | 240 | 36 | 26 | 24 | 20 | 16 | 6 | 3 | 15 | 3 | 4 | 10 | 5 | 1 | 2 | 3 | 2 | 1 | 2 | 9 | 13 | 119 | 8 | 3 | 5 | 3 | 1 | 4 | 4 | 1 | 3 | 1 | 1 | 1 | 1 | 215 | **907** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `50.74%` |
| 2 | `[长效备份] hysteria2 节点` | **175** 个 | `16.14%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.28%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **60** 个 | `5.54%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `3.97%` |
| 6 | `[长效备份] hy2 节点` | **36** 个 | `3.32%` |
| 7 | `📡 shaoyouvip 每日更新` | **35** 个 | `3.23%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.85%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.29%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.65%` |
| **-** | **总计 (包含跨源重合)** | **1084** 个 | `100.00%` |
