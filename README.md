...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-10--08%3A33%3A22-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-978-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-10 08:33:22`
> 运行分析：从 `10` 个活跃源中抓取 `1147` 个节点，耗时 `2.14s`。去重后保留 `978` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇵🇹葡萄牙 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 45 | 274 | 35 | 27 | 26 | 25 | 19 | 5 | 3 | 17 | 3 | 4 | 10 | 7 | 1 | 1 | 2 | 4 | 1 | 1 | 10 | 14 | 128 | 10 | 4 | 4 | 3 | 4 | 3 | 2 | 2 | 2 | 1 | 1 | 1 | 229 | **978** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `48.63%` |
| 2 | `[长效备份] hysteria2 节点` | **154** 个 | `13.62%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.73%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `8.93%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **62** 个 | `5.48%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.80%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.18%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.77%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.24%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.62%` |
| **-** | **总计 (包含跨源重合)** | **1131** 个 | `100.00%` |
