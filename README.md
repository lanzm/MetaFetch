...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-12--00%3A03%3A42-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-891-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-12 00:03:42`
> 运行分析：从 `19` 个活跃源中抓取 `1107` 个节点，耗时 `2.50s`。去重后保留 `891` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 46 | 12 | 46 | 277 | 39 | 26 | 17 | 26 | 20 | 5 | 5 | 25 | 4 | 8 | 8 | 98 | 12 | 4 | 4 | 5 | 204 | **891** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-12 00:03:43`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `50.51%` |
| 2 | `📡 Zhangkai 系列` | **159** 个 | `14.68%` |
| 3 | `[长效备份] hy2 节点` | **75** 个 | `6.93%` |
| 4 | `[长效备份] hysteria2 节点` | **52** 个 | `4.80%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `4.06%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.97%` |
| 7 | `📡 shaoyouvip 每日更新` | **21** 个 | `1.94%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.85%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.29%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `1.29%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `1.29%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `1.29%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `1.29%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `1.29%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `1.29%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `1.29%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.92%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1083** 个 | `100.00%` |
