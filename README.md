...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-14--03%3A07%3A42-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1999-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-14 03:07:42`
> 运行分析：从 `19` 个活跃源中抓取 `2612` 个节点，耗时 `3.06s`。去重后保留 `1999` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 49 | 11 | 45 | 310 | 36 | 24 | 30 | 33 | 20 | 6 | 6 | 26 | 4 | 9 | 8 | 9 | 98 | 4 | 4 | 5 | 1262 | **1999** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-14 03:07:43`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1429** 个 | `55.30%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.17%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.15%` |
| 4 | `[长效备份] hysteria2 节点` | **67** 个 | `2.59%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `2.09%` |
| 6 | `[长效备份] hy2 节点` | **52** 个 | `2.01%` |
| 7 | `📡 shaoyouvip 每日更新` | **49** 个 | `1.90%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.66%` |
| 9 | `[动态日期] NodeFree YAML` | **28** 个 | `1.08%` |
| 10 | `[动态日期] v2rayShare YAML` | **28** 个 | `1.08%` |
| 11 | `[动态日期] oneClash YAML` | **28** 个 | `1.08%` |
| 12 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.77%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.54%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `0.54%` |
| 15 | `[动态日期] NodeFree TXT` | **14** 个 | `0.54%` |
| 16 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.54%` |
| 17 | `[动态日期] oneClash TXT` | **14** 个 | `0.54%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2584** 个 | `100.00%` |
