...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-06--19%3A19%3A09-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-918-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-06 19:19:09`
> 运行分析：从 `10` 个活跃源中抓取 `1056` 个节点，耗时 `2.08s`。去重后保留 `918` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 11 | 47 | 242 | 33 | 28 | 25 | 15 | 15 | 5 | 4 | 16 | 2 | 4 | 10 | 7 | 1 | 1 | 3 | 4 | 1 | 8 | 16 | 120 | 11 | 3 | 2 | 6 | 4 | 3 | 2 | 2 | 1 | 1 | 224 | **918** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `52.88%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.85%` |
| 3 | `[长效备份] hysteria2 节点` | **136** 个 | `13.08%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **62** 个 | `5.96%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `4.13%` |
| 6 | `[长效备份] hy2 节点` | **36** 个 | `3.46%` |
| 7 | `📡 shaoyouvip 每日更新` | **28** 个 | `2.69%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.92%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.35%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.67%` |
| **-** | **总计 (包含跨源重合)** | **1040** 个 | `100.00%` |
