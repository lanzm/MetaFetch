...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-07--12%3A58%3A20-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1868-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-07 12:58:20`
> 运行分析：从 `19` 个活跃源中抓取 `2574` 个节点，耗时 `2.66s`。去重后保留 `1868` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 51 | 12 | 47 | 264 | 34 | 26 | 33 | 30 | 18 | 13 | 4 | 20 | 5 | 4 | 12 | 9 | 4 | 60 | 4 | 5 | 1213 | **1868** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-07 12:58:20`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1406** 个 | `55.25%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.49%` |
| 3 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.93%` |
| 4 | `[长效备份] hysteria2 节点` | **77** 个 | `3.03%` |
| 5 | `[长效备份] hy2 节点` | **67** 个 | `2.63%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `1.85%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.69%` |
| 8 | `[动态日期] NodeFree TXT` | **30** 个 | `1.18%` |
| 9 | `[动态日期] NodeFree YAML` | **30** 个 | `1.18%` |
| 10 | `[动态日期] v2rayShare TXT` | **30** 个 | `1.18%` |
| 11 | `[动态日期] v2rayShare YAML` | **30** 个 | `1.18%` |
| 12 | `[动态日期] oneClash TXT` | **30** 个 | `1.18%` |
| 13 | `[动态日期] oneClash YAML` | **30** 个 | `1.18%` |
| 14 | `📡 Zhangkai 系列` | **25** 个 | `0.98%` |
| 15 | `📱 Pawdroid 免费节点库` | **15** 个 | `0.59%` |
| 16 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.55%` |
| 17 | `📡 FreeFQ 每日福利` | **14** 个 | `0.55%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2545** 个 | `100.00%` |
