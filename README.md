...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-15--14%3A45%3A55-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2028-orange.svg)
...
> 运行分析：从 `19` 个活跃源中抓取 `2652` 个节点，耗时 `2.72s`。去重后保留 `2028` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 46 | 11 | 60 | 302 | 42 | 27 | 20 | 34 | 16 | 10 | 27 | 4 | 11 | 7 | 120 | 4 | 4 | 7 | 4 | 1272 | **2028** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-15 14:45:56`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1449** 个 | `55.22%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.85%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.06%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `3.85%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **77** 个 | `2.93%` |
| 6 | `[长效备份] hysteria2 节点` | **59** 个 | `2.25%` |
| 7 | `[长效备份] hy2 节点` | **54** 个 | `2.06%` |
...
| 17 | `📱 Pawdroid 免费节点库` | **13** 个 | `0.50%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.38%` |
| **-** | **总计 (包含跨源重合)** | **2624** 个 | `100.00%` |
