...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-11--08%3A30%3A47-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-972-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-11 08:30:47`
> 运行分析：从 `10` 个活跃源中抓取 `1160` 个节点，耗时 `2.01s`。去重后保留 `972` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 12 | 46 | 272 | 34 | 26 | 32 | 17 | 23 | 9 | 4 | 20 | 3 | 4 | 11 | 7 | 1 | 2 | 4 | 1 | 2 | 9 | 13 | 127 | 9 | 5 | 3 | 3 | 5 | 3 | 2 | 2 | 1 | 1 | 1 | 1 | 218 | **972** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `48.03%` |
| 2 | `[长效备份] hysteria2 节点` | **178** 个 | `15.55%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.58%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `8.73%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **55** 个 | `4.80%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.76%` |
| 7 | `[长效备份] hy2 节点` | **34** 个 | `2.97%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.75%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.22%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.61%` |
| **-** | **总计 (包含跨源重合)** | **1145** 个 | `100.00%` |
