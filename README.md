...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-12--12%3A51%3A20-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1958-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-12 12:51:20`
> 运行分析：从 `19` 个活跃源中抓取 `2520` 个节点，耗时 `3.84s`。去重后保留 `1958` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 11 | 49 | 302 | 34 | 27 | 28 | 31 | 21 | 6 | 25 | 5 | 8 | 8 | 5 | 98 | 7 | 4 | 4 | 5 | 1230 | **1958** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-12 12:51:21`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1405** 个 | `56.40%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `21.96%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.38%` |
| 4 | `[长效备份] hy2 节点` | **68** 个 | `2.73%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **49** 个 | `1.97%` |
| 6 | `[长效备份] hysteria2 节点` | **46** 个 | `1.85%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.73%` |
| 8 | `📡 shaoyouvip 每日更新` | **32** 个 | `1.28%` |
| 9 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.80%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.56%` |
| 11 | `📡 FreeFQ 每日福利` | **14** 个 | `0.56%` |
| 12 | `[动态日期] NodeFree TXT` | **14** 个 | `0.56%` |
| 13 | `[动态日期] NodeFree YAML` | **14** 个 | `0.56%` |
| 14 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.56%` |
| 15 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.56%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `0.56%` |
| 17 | `[动态日期] oneClash YAML` | **14** 个 | `0.56%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.40%` |
| **-** | **总计 (包含跨源重合)** | **2491** 个 | `100.00%` |
