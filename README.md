...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-07--20%3A59%3A27-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-944-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-07 20:59:27`
> 运行分析：从 `10` 个活跃源中抓取 `1079` 个节点，耗时 `1.79s`。去重后保留 `944` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 48 | 256 | 34 | 27 | 28 | 20 | 13 | 6 | 4 | 18 | 4 | 4 | 10 | 5 | 1 | 1 | 2 | 4 | 1 | 2 | 11 | 13 | 121 | 14 | 3 | 3 | 3 | 3 | 7 | 3 | 2 | 4 | 1 | 1 | 1 | 1 | 215 | **944** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `51.74%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.55%` |
| 3 | `[长效备份] hysteria2 节点` | **133** 个 | `12.51%` |
| 4 | `📡 shaoyouvip 每日更新` | **64** 个 | `6.02%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `4.89%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `4.05%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.39%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.88%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.32%` |
