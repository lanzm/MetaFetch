...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-18--17%3A37%3A43-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2094-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-18 17:37:43`
> 运行分析：从 `19` 个活跃源中抓取 `2718` 个节点，耗时 `4.09s`。去重后保留 `2094` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇺🇦乌克兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 61 | 14 | 51 | 305 | 41 | 32 | 23 | 28 | 21 | 8 | 4 | 27 | 4 | 11 | 7 | 93 | 7 | 6 | 8 | 7 | 4 | 1332 | **2094** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-18 17:37:44`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1514** 个 | `56.28%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.33%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `5.91%` |
| 4 | `[长效备份] hysteria2 节点` | **125** 个 | `4.65%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `2.38%` |
| 6 | `[长效备份] hy2 节点` | **50** 个 | `1.86%` |
| 7 | `📡 shaoyouvip 每日更新` | **46** 个 | `1.71%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.60%` |
