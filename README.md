...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-12--13%3A02%3A25-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-970-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-12 13:02:25`
> 运行分析：从 `10` 个活跃源中抓取 `1163` 个节点，耗时 `2.19s`。去重后保留 `970` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇭🇺匈牙利 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 41 | 12 | 45 | 271 | 35 | 25 | 28 | 20 | 17 | 5 | 6 | 17 | 4 | 4 | 12 | 6 | 1 | 1 | 3 | 2 | 1 | 2 | 10 | 13 | 128 | 10 | 5 | 4 | 4 | 5 | 3 | 1 | 3 | 2 | 1 | 1 | 3 | 219 | **970** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `47.91%` |
| 2 | `[长效备份] hysteria2 节点` | **168** 个 | `14.63%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.54%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `8.80%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **64** 个 | `5.57%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.75%` |
| 7 | `[长效备份] hy2 节点` | **37** 个 | `3.22%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.74%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.22%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.61%` |
| **-** | **总计 (包含跨源重合)** | **1148** 个 | `100.00%` |
