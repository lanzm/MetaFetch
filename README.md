...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-26--09%3A39%3A12-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2262-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-26 09:39:12`
> 运行分析：从 `19` 个活跃源中抓取 `2930` 个节点，耗时 `1.99s`。去重后保留 `2262` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇧🇬保加利亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 52 | 12 | 48 | 272 | 40 | 27 | 28 | 28 | 27 | 19 | 5 | 28 | 4 | 21 | 7 | 6 | 130 | 4 | 6 | 6 | 5 | 5 | 4 | 5 | 1473 | **2262** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1681** 个 | `57.89%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `18.94%` |
| 3 | `📡 Zhangkai 系列` | **144** 个 | `4.96%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `3.44%` |
| 5 | `[长效备份] hysteria2 节点` | **75** 个 | `2.58%` |
| 6 | `[长效备份] hy2 节点` | **52** 个 | `1.79%` |
| 7 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `1.62%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.48%` |
| 9 | `[动态日期] NodeFree TXT` | **25** 个 | `0.86%` |
| 10 | `[动态日期] v2rayShare TXT` | **25** 个 | `0.86%` |
| 11 | `[动态日期] oneClash TXT` | **25** 个 | `0.86%` |
| 12 | `[动态日期] NodeFree YAML` | **24** 个 | `0.83%` |
| 13 | `[动态日期] v2rayShare YAML` | **24** 个 | `0.83%` |
| 14 | `[动态日期] oneClash YAML` | **24** 个 | `0.83%` |
| 15 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.69%` |
| 16 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.48%` |
| 17 | `📡 FreeFQ 每日福利` | **14** 个 | `0.48%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.34%` |
| 19 | `我的私密机场 1` | **7** 个 | `0.24%` |
| **-** | **总计 (包含跨源重合)** | **2904** 个 | `100.00%` |
