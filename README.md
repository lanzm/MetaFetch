...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--10%3A52%3A23-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1667-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 10:52:23`
> 运行分析：从 `19` 个活跃源中抓取 `2144` 个节点，耗时 `3.24s`。去重后保留 `1667` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 55 | 11 | 47 | 255 | 35 | 25 | 28 | 17 | 15 | 14 | 4 | 9 | 4 | 14 | 9 | 96 | 7 | 4 | 4 | 1014 | **1667** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 10:52:24`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `49.91%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `25.92%` |
| 3 | `📡 shaoyouvip 每日更新` | **101** 个 | `4.79%` |
| 4 | `📡 Zhangkai 系列` | **74** 个 | `3.51%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **52** 个 | `2.46%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.04%` |
| 7 | `[长效备份] hysteria2 节点` | **42** 个 | `1.99%` |
| 8 | `[动态日期] NodeFree TXT` | **25** 个 | `1.18%` |
| 9 | `[动态日期] v2rayShare TXT` | **25** 个 | `1.18%` |
| 10 | `[动态日期] oneClash TXT` | **25** 个 | `1.18%` |
| 11 | `[动态日期] NodeFree YAML` | **24** 个 | `1.14%` |
| 12 | `[动态日期] v2rayShare YAML` | **24** 个 | `1.14%` |
| 13 | `[动态日期] oneClash YAML` | **24** 个 | `1.14%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.66%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.66%` |
| 16 | `📱 Pawdroid 免费节点库` | **11** 个 | `0.52%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.47%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.09%` |
| **-** | **总计 (包含跨源重合)** | **2110** 个 | `100.00%` |
