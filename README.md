...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-30--08%3A39%3A34-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-963-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-30 08:39:34`
> 运行分析：从 `10` 个活跃源中抓取 `1119` 个节点，耗时 `1.97s`。去重后保留 `963` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇰🇿哈萨克斯坦 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 44 | 12 | 48 | 263 | 39 | 24 | 26 | 25 | 23 | 4 | 5 | 17 | 4 | 4 | 12 | 3 | 2 | 1 | 4 | 2 | 8 | 15 | 123 | 12 | 3 | 2 | 10 | 3 | 3 | 1 | 2 | 3 | 1 | 2 | 1 | 4 | 1 | 207 | **963** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `49.95%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.08%` |
| 3 | `[长效备份] hysteria2 节点` | **119** 个 | `10.81%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `9.17%` |
| 5 | `[长效备份] hy2 节点` | **56** 个 | `5.09%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `4.27%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `3.91%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.82%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.27%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.64%` |
| **-** | **总计 (包含跨源重合)** | **1101** 个 | `100.00%` |
