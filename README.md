...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-15--17%3A30%3A27-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2029-orange.svg)
...
> 运行分析：从 `19` 个活跃源中抓取 `2656` 个节点，耗时 `3.60s`。去重后保留 `2029` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 11 | 60 | 306 | 40 | 28 | 21 | 32 | 16 | 10 | 28 | 5 | 10 | 7 | 119 | 5 | 4 | 7 | 4 | 1268 | **2029** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-15 17:30:28`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1449** 个 | `55.14%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.81%` |
| 3 | `📡 Zhangkai 系列` | **159** 个 | `6.05%` |
| 4 | `📡 shaoyouvip 每日更新` | **101** 个 | `3.84%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **77** 个 | `2.93%` |
| 6 | `[长效备份] hy2 节点` | **61** 个 | `2.32%` |
| 7 | `[长效备份] hysteria2 节点` | **57** 个 | `2.17%` |
| 8 | `📡 Huibq 聚合` | **43** 个 | `1.64%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.53%` |
| 10 | `📡 FreeFQ 每日福利` | **14** 个 | `0.53%` |
| 11 | `[动态日期] NodeFree TXT` | **14** 个 | `0.53%` |
| 12 | `[动态日期] NodeFree YAML` | **14** 个 | `0.53%` |
| 13 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.53%` |
| 14 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.53%` |
| 15 | `[动态日期] oneClash TXT` | **14** 个 | `0.53%` |
| 16 | `[动态日期] oneClash YAML` | **14** 个 | `0.53%` |
| 17 | `📱 Pawdroid 免费节点库` | **12** 个 | `0.46%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.38%` |
| **-** | **总计 (包含跨源重合)** | **2628** 个 | `100.00%` |
