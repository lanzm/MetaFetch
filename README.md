...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-07--04%3A50%3A27-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-981-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-07 04:50:27`
> 运行分析：从 `10` 个活跃源中抓取 `1124` 个节点，耗时 `1.80s`。去重后保留 `981` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇮🇩印尼 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇩🇰丹麦 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 46 | 260 | 36 | 28 | 29 | 17 | 18 | 7 | 4 | 26 | 4 | 4 | 10 | 6 | 1 | 1 | 3 | 4 | 1 | 2 | 11 | 13 | 128 | 20 | 2 | 5 | 5 | 1 | 7 | 3 | 2 | 3 | 1 | 1 | 1 | 1 | 219 | **981** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `49.64%` |
| 2 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `13.00%` |
| 3 | `[长效备份] hysteria2 节点` | **138** 个 | `12.45%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `9.03%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **56** 个 | `5.05%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.88%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.25%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.81%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.26%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.63%` |
| **-** | **总计 (包含跨源重合)** | **1108** 个 | `100.00%` |
