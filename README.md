...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-28--16%3A42%3A32-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-28 16:42:32`
> 运行分析：从 `19` 个活跃源中抓取 `2109` 个节点，耗时 `2.89s`。去重后保留 `1621` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 12 | 44 | 260 | 35 | 26 | 22 | 18 | 17 | 12 | 13 | 7 | 4 | 70 | 5 | 4 | 1022 | **1621** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-28 16:42:33`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1053** 个 | `50.75%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.36%` |
| 3 | `📡 Zhangkai 系列` | **81** 个 | `3.90%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **67** 个 | `3.23%` |
| 5 | `📡 Huibq 聚合` | **43** 个 | `2.07%` |
| 6 | `[长效备份] hysteria2 节点` | **42** 个 | `2.02%` |
| 7 | `📡 shaoyouvip 每日更新` | **35** 个 | `1.69%` |
...
| 14 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.96%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.67%` |
| 16 | `📡 FreeFQ 每日福利` | **14** 个 | `0.67%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.48%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2075** 个 | `100.00%` |
