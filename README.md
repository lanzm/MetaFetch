...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-26--16%3A33%3A31-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-26 16:33:31`
> 运行分析：从 `19` 个活跃源中抓取 `2080` 个节点，耗时 `3.61s`。去重后保留 `1604` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇸🇪瑞典 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 51 | 13 | 47 | 247 | 39 | 23 | 23 | 20 | 15 | 11 | 4 | 4 | 13 | 7 | 77 | 4 | 1006 | **1604** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-26 16:33:32`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1042** 个 | `50.93%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `26.74%` |
| 3 | `📡 Zhangkai 系列` | **86** 个 | `4.20%` |
| 4 | `[长效备份] hysteria2 节点` | **56** 个 | `2.74%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **47** 个 | `2.30%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `2.10%` |
...
| 13 | `📡 shaoyouvip 每日更新` | **22** 个 | `1.08%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.68%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.68%` |
| 16 | `📱 Pawdroid 免费节点库` | **10** 个 | `0.49%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.49%` |
| 18 | `[长效备份] hy2 节点` | **8** 个 | `0.39%` |
| **-** | **总计 (包含跨源重合)** | **2046** 个 | `100.00%` |
