...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-07-27--22%3A46%3A50-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1581-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-07-27 22:46:50`
> 运行分析：从 `19` 个活跃源中抓取 `2041` 个节点，耗时 `3.27s`。去重后保留 `1581` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 11 | 47 | 243 | 32 | 25 | 21 | 16 | 14 | 13 | 4 | 6 | 4 | 13 | 7 | 60 | 19 | 999 | **1581** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-07-27 22:46:51`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1043** 个 | `51.97%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `27.25%` |
| 3 | `📡 Zhangkai 系列` | **74** 个 | `3.69%` |
| 4 | `[长效备份] hysteria2 节点` | **55** 个 | `2.74%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `2.19%` |
...
| 17 | `📡 shaoyouvip 每日更新` | **4** 个 | `0.20%` |
| 18 | `[长效备份] hy2 节点` | **2** 个 | `0.10%` |
| **-** | **总计 (包含跨源重合)** | **2007** 个 | `100.00%` |
