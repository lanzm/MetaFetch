...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-04--01%3A11%3A46-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-818-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-04 01:11:46`
> 运行分析：从 `19` 个活跃源中抓取 `1136` 个节点，耗时 `2.70s`。去重后保留 `818` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇵🇱波兰 | 🇦🇪阿联酋 | 🇧🇬保加利亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 54 | 11 | 71 | 229 | 34 | 40 | 19 | 16 | 12 | 4 | 6 | 9 | 4 | 7 | 8 | 66 | 4 | 5 | 5 | 214 | **818** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-04 01:11:47`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `49.15%` |
| 2 | `📡 Zhangkai 系列` | **92** 个 | `8.27%` |
| 3 | `⚡ Misaka Chromego 聚合池` | **79** 个 | `7.10%` |
| 4 | `📡 shaoyouvip 每日更新` | **59** 个 | `5.30%` |
| 5 | `[长效备份] hysteria2 节点` | **54** 个 | `4.85%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.86%` |
| 7 | `[动态日期] NodeFree TXT` | **30** 个 | `2.70%` |
| 8 | `[动态日期] NodeFree YAML` | **30** 个 | `2.70%` |
| 9 | `[动态日期] v2rayShare TXT` | **30** 个 | `2.70%` |
| 10 | `[动态日期] v2rayShare YAML` | **30** 个 | `2.70%` |
| 11 | `[动态日期] oneClash TXT` | **30** 个 | `2.70%` |
| 12 | `[动态日期] oneClash YAML` | **30** 个 | `2.70%` |
| 13 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.26%` |
| 14 | `📡 FreeFQ 每日福利` | **14** 个 | `1.26%` |
| 15 | `📱 Pawdroid 免费节点库` | **12** 个 | `1.08%` |
| 16 | `[长效备份] peasoft 精选` | **10** 个 | `0.90%` |
| 17 | `[长效备份] hy2 节点` | **9** 个 | `0.81%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **1113** 个 | `100.00%` |
