...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-03--17%3A55%3A13-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1998-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-03 17:55:13`
> 运行分析：从 `19` 个活跃源中抓取 `2685` 个节点，耗时 `3.44s`。去重后保留 `1998` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇪阿联酋 | 🇺🇦乌克兰 | 🇧🇬保加利亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 56 | 12 | 46 | 347 | 32 | 32 | 26 | 40 | 17 | 15 | 25 | 11 | 7 | 4 | 131 | 4 | 6 | 5 | 4 | 5 | 5 | 4 | 6 | 1158 | **1998** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-03 17:55:14`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1320** 个 | `49.70%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `20.59%` |
| 3 | `📡 Zhangkai 系列` | **344** 个 | `12.95%` |
| 4 | `⚡ Misaka Chromego 聚合池` | **79** 个 | `2.97%` |
| 5 | `[长效备份] hysteria2 节点` | **56** 个 | `2.11%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `1.62%` |
| 7 | `[动态日期] NodeFree TXT` | **30** 个 | `1.13%` |
| 8 | `[动态日期] NodeFree YAML` | **30** 个 | `1.13%` |
| 9 | `[动态日期] v2rayShare TXT` | **30** 个 | `1.13%` |
| 10 | `[动态日期] v2rayShare YAML` | **30** 个 | `1.13%` |
| 11 | `[动态日期] oneClash TXT` | **30** 个 | `1.13%` |
| 12 | `[动态日期] oneClash YAML` | **30** 个 | `1.13%` |
| 13 | `📡 shaoyouvip 每日更新` | **23** 个 | `0.87%` |
| 14 | `📱 Pawdroid 免费节点库` | **17** 个 | `0.64%` |
| 15 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.53%` |
| 16 | `📡 FreeFQ 每日福利` | **14** 个 | `0.53%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.38%` |
| 18 | `[长效备份] hy2 节点` | **9** 个 | `0.34%` |
| **-** | **总计 (包含跨源重合)** | **2656** 个 | `100.00%` |
