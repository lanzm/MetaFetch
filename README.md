...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-01--13%3A37%3A18-green.svg?style=flat-square)
...
> 运行分析：从 `10` 个活跃源中抓取 `1178` 个节点，耗时 `2.47s`。去重后保留 `980` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇻🇳越南 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇵🇭菲律宾 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 47 | 12 | 46 | 259 | 42 | 28 | 35 | 20 | 32 | 6 | 7 | 1 | 18 | 3 | 3 | 17 | 3 | 1 | 2 | 3 | 5 | 1 | 1 | 9 | 14 | 127 | 12 | 2 | 7 | 4 | 4 | 2 | 2 | 3 | 1 | 1 | 1 | 3 | 196 | **980** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `47.41%` |
| 2 | `[长效备份] hysteria2 节点` | **152** 个 | `13.10%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.41%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `8.62%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **88** 个 | `7.59%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.71%` |
| 7 | `[长效备份] hy2 节点` | **42** 个 | `3.62%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `1.72%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.21%` |
| 10 | `我的私密机场 1` | **7** 个 | `0.60%` |
| **-** | **总计 (包含跨源重合)** | **1160** 个 | `100.00%` |
