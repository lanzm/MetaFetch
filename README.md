...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-13--13%3A20%3A35-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-966-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-13 13:20:35`
> 运行分析：从 `10` 个活跃源中抓取 `1152` 个节点，耗时 `1.83s`。去重后保留 `966` 个有效节点。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 39 | 11 | 46 | 262 | 34 | 25 | 28 | 20 | 20 | 5 | 3 | 18 | 6 | 4 | 9 | 6 | 1 | 4 | 2 | 1 | 11 | 13 | 129 | 10 | 5 | 7 | 4 | 1 | 5 | 4 | 1 | 2 | 1 | 1 | 2 | 226 | **966** |
...
| 2 | `[长效备份] hysteria2 节点` | **170** 个 | `14.95%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.66%` |
| 4 | `📡 shaoyouvip 每日更新` | **100** 个 | `8.80%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **54** 个 | `4.75%` |
| 6 | `📡 Huibq 聚合` | **43** 个 | `3.78%` |
| 7 | `[长效备份] hy2 节点` | **36** 个 | `3.17%` |
| 8 | `📱 Pawdroid 免费节点库` | **19** 个 | `1.67%` |
| 9 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.23%` |
