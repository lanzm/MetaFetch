...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-09-10--13%3A13%3A51-green.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-09-10 13:13:51`
> 运行分析：从 `10` 个活跃源中抓取 `1145` 个节点，耗时 `2.03s`。去重后保留 `980` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇨🇭瑞士 | 🇮🇳印度 | 🇹🇷土耳其 | 🇦🇺澳大利亚 | 🇲🇾马来西亚 | 🇧🇷巴西 | 🇦🇷阿根廷 | 🇲🇽墨西哥 | 🇮🇹意大利 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇮🇪爱尔兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇨🇿捷克 | 🇦🇹奥地利 | 🇦🇪阿联酋 | 🇨🇾塞浦路斯 | 🇺🇦乌克兰 | 🇳🇴挪威 | 🇵🇹葡萄牙 | 🇭🇺匈牙利 | 🇧🇬保加利亚 | 🇿🇦南非 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 40 | 11 | 47 | 259 | 37 | 31 | 30 | 31 | 15 | 5 | 5 | 13 | 3 | 4 | 10 | 7 | 1 | 2 | 4 | 1 | 2 | 11 | 15 | 125 | 9 | 4 | 6 | 3 | 1 | 6 | 3 | 2 | 2 | 1 | 2 | 1 | 1 | 1 | 229 | **980** |
...
| 2 | `[长效备份] hysteria2 节点` | **154** 个 | `13.64%` |
| 3 | `📡 Zhangkai 系列 (speednodes)` | **144** 个 | `12.75%` |
| 4 | `📡 shaoyouvip 每日更新` | **99** 个 | `8.77%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **62** 个 | `5.49%` |
