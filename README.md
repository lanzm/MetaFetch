...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-02--11%3A25%3A22-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-1869-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-02 11:25:22`
> 运行分析：从 `19` 个活跃源中抓取 `2438` 个节点，耗时 `3.18s`。去重后保留 `1869` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇸🇪瑞典 | 🇵🇱波兰 | 🇦🇹奥地利 | 🇰🇿哈萨克斯坦 | 🇺🇦乌克兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 54 | 14 | 45 | 297 | 32 | 27 | 34 | 27 | 14 | 22 | 4 | 17 | 4 | 14 | 8 | 113 | 11 | 6 | 5 | 4 | 4 | 4 | 1109 | **1869** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-02 11:25:23`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1256** 个 | `52.38%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `22.81%` |
| 3 | `📡 Zhangkai 系列` | **194** 个 | `8.09%` |
| 4 | `📡 shaoyouvip 每日更新` | **96** 个 | `4.00%` |
| 5 | `[长效备份] hysteria2 节点` | **54** 个 | `2.25%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **44** 个 | `1.83%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.79%` |
| 8 | `[动态日期] NodeFree YAML` | **20** 个 | `0.83%` |
| 9 | `[动态日期] v2rayShare YAML` | **20** 个 | `0.83%` |
| 10 | `[动态日期] oneClash YAML` | **20** 个 | `0.83%` |
| 11 | `[动态日期] NodeFree TXT` | **16** 个 | `0.67%` |
| 12 | `[动态日期] v2rayShare TXT` | **16** 个 | `0.67%` |
| 13 | `[动态日期] oneClash TXT` | **16** 个 | `0.67%` |
| 14 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.58%` |
| 15 | `📡 FreeFQ 每日福利` | **14** 个 | `0.58%` |
| 16 | `📱 Pawdroid 免费节点库` | **14** 个 | `0.58%` |
| 17 | `[长效备份] peasoft 精选` | **10** 个 | `0.42%` |
| 18 | `[长效备份] hy2 节点` | **4** 个 | `0.17%` |
| **-** | **总计 (包含跨源重合)** | **2398** 个 | `100.00%` |
