...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-25--14%3A55%3A25-green.svg?style=flat-square)
![Nodes](https://img.shields.io/badge/Valid_Nodes-2180-orange.svg?style=flat-square)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-25 14:55:25`
> 运行分析：从 `19` 个活跃源中抓取 `2844` 个节点，耗时 `2.47s`。去重后保留 `2180` 个有效节点。

<div style="overflow-x: auto;">

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 50 | 13 | 48 | 253 | 37 | 26 | 20 | 27 | 16 | 18 | 6 | 12 | 4 | 13 | 7 | 7 | 120 | 1503 | **2180** |
...
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1662** 个 | `58.98%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **550** 个 | `19.52%` |
| 3 | `📡 Zhangkai 系列` | **144** 个 | `5.11%` |
| 4 | `[长效备份] hysteria2 节点` | **68** 个 | `2.41%` |
| 5 | `[长效备份] hy2 节点` | **62** 个 | `2.20%` |
| 6 | `⚡ Misaka Chromego 聚合池` | **49** 个 | `1.74%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.53%` |
| 8 | `📡 shaoyouvip 每日更新` | **34** 个 | `1.21%` |
...
| 17 | `📱 Pawdroid 免费节点库` | **14** 个 | `0.50%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.35%` |
| 19 | `我的私密机场 1` | **7** 个 | `0.25%` |
| **-** | **总计 (包含跨源重合)** | **2818** 个 | `100.00%` |
