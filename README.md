...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-01--00%3A48%3A26-green.svg)
![Nodes](https://img.shields.io/badge/Valid_Nodes-772-orange.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-01 00:48:26`
> 运行分析：从 `19` 个活跃源中抓取 `998` 个节点，耗时 `3.00s`。去重后保留 `772` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇨🇦加拿大 | 🇳🇱荷兰 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 48 | 13 | 43 | 241 | 33 | 25 | 19 | 13 | 11 | 6 | 4 | 11 | 7 | 7 | 66 | 5 | 220 | **772** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-01 00:48:26`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `56.74%` |
| 2 | `📡 Zhangkai 系列` | **110** 个 | `11.41%` |
| 3 | `[长效备份] hysteria2 节点` | **55** 个 | `5.71%` |
| 4 | `📡 Huibq 聚合` | **43** 个 | `4.46%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **40** 个 | `4.15%` |
| 6 | `[动态日期] NodeFree YAML` | **20** 个 | `2.07%` |
| 7 | `[动态日期] v2rayShare YAML` | **20** 个 | `2.07%` |
| 8 | `[动态日期] oneClash YAML` | **20** 个 | `2.07%` |
| 9 | `[动态日期] NodeFree TXT` | **16** 个 | `1.66%` |
| 10 | `[动态日期] v2rayShare TXT` | **16** 个 | `1.66%` |
| 11 | `[动态日期] oneClash TXT` | **16** 个 | `1.66%` |
| 12 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `1.45%` |
| 13 | `📡 FreeFQ 每日福利` | **14** 个 | `1.45%` |
| 14 | `📱 Pawdroid 免费节点库` | **12** 个 | `1.24%` |
| 15 | `[长效备份] peasoft 精选` | **10** 个 | `1.04%` |
| 16 | `📡 shaoyouvip 每日更新` | **7** 个 | `0.73%` |
| 17 | `[长效备份] hy2 节点` | **4** 个 | `0.41%` |
| 18 | `🔥🔥🔥 ClashGitHub` | **0** 个 | `0.00%` |
| **-** | **总计 (包含跨源重合)** | **964** 个 | `100.00%` |
