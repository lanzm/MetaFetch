...
<!-- STATS_BADGE_START -->
![Update](https://img.shields.io/badge/Updated-2026-08-11--15%3A15%3A16-green.svg)
...
<!-- STATS_TABLE_START -->
> 更新时间：`2026-08-11 15:15:16`
> 运行分析：从 `19` 个活跃源中抓取 `2370` 个节点，耗时 `3.32s`。去重后保留 `1812` 个有效节点。

| 地区分布 | 🇭🇰香港 | 🇹🇼台湾 | 🇯🇵日本 | 🇺🇸美国 | 🇸🇬新加坡 | 🇰🇷韩国 | 🇩🇪德国 | 🇬🇧英国 | 🇫🇷法国 | 🇷🇺俄罗斯 | 🇳🇱荷兰 | 🇮🇳印度 | 🇹🇷土耳其 | 🇪🇸西班牙 | 🇨🇳中国 | 🇷🇴罗马尼亚 | 🇫🇮芬兰 | 🇵🇱波兰 | 🇦🇹奥地利 | 🌍其他 | **总计** |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **数量** | 46 | 11 | 45 | 236 | 36 | 28 | 17 | 27 | 22 | 8 | 20 | 4 | 8 | 8 | 4 | 51 | 5 | 4 | 4 | 1228 | **1812** |
<!-- STATS_TABLE_END -->
...
> 数据计算时间：`2026-08-11 15:15:18`

<div style="width: 100%; max-height: 260px; overflow-y: auto;">

| 排名 | 订阅源名称 | 有效节点数 | 节点贡献占比 |
| :---: | :--- | :---: | :---: |
| 1 | `🔥🔥🔥 ClashGitHub` | **1348** 个 | `57.58%` |
| 2 | `🔥🔥🔥 w1770946466 长期订阅` | **547** 个 | `23.37%` |
| 3 | `[长效备份] hy2 节点` | **68** 个 | `2.90%` |
| 4 | `📡 Zhangkai 系列` | **67** 个 | `2.86%` |
| 5 | `⚡ Misaka Chromego 聚合池` | **57** 个 | `2.43%` |
| 6 | `[长效备份] hysteria2 节点` | **53** 个 | `2.26%` |
| 7 | `📡 Huibq 聚合` | **43** 个 | `1.84%` |
| 8 | `📱 Pawdroid 免费节点库` | **20** 个 | `0.85%` |
| 9 | `📡 shaoyouvip 每日更新` | **16** 个 | `0.68%` |
| 10 | `🔥🔥🔥 日抛机场系列` | **14** 个 | `0.60%` |
| 11 | `📡 FreeFQ 每日福利` | **14** 个 | `0.60%` |
| 12 | `[动态日期] NodeFree TXT` | **14** 个 | `0.60%` |
| 13 | `[动态日期] NodeFree YAML` | **14** 个 | `0.60%` |
| 14 | `[动态日期] v2rayShare TXT` | **14** 个 | `0.60%` |
| 15 | `[动态日期] v2rayShare YAML` | **14** 个 | `0.60%` |
| 16 | `[动态日期] oneClash TXT` | **14** 个 | `0.60%` |
| 17 | `[动态日期] oneClash YAML` | **14** 个 | `0.60%` |
| 18 | `[长效备份] peasoft 精选` | **10** 个 | `0.43%` |
| **-** | **总计 (包含跨源重合)** | **2341** 个 | `100.00%` |
